...
class ArduinoNode(Node):
    ...
    def __init__(self):
        ...
        self.motor = [int(0),int(0),int(0),int(0),int(0),int(0),int(0), int(0)] #list of 8 components:start, right wheel, left wheel, lift r, lift l, tilt r, tilt l, vibr
    ...
    def cmdvelcallback(self,msg):
        ...
        self.motor = [0, r_motor, l_motor,r_lin_act,l_lin_act, r_tilt_act, l_tilt_act, vibr]
    ...
    def Arduino_command(self):
        ...
        if self.ser.in_waiting > 0:
            ...
            values = line.split(',')
            command_values = [int(value) for value in values[1:8]]
            lift_feedback = [int(value) for value in values[8:10]]
            ...
            tilt_feedback = [int(value) for value in values[10:12]]
            motors_feedback = [value for value in values[12:]]
        ...
        packed_data = struct.pack('8B',*self.motor)
